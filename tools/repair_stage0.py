...
The current compiler.c is generated legacy Stage-0 code.  This codemod is kept
small, explicit, and idempotent so the repair can be reviewed as source-level
changes instead of being hidden inside CI.
"""
