...
int returns_int(char* fn) {
    if (__wear_streq(fn, "panjang")) {
        return 1;
    }
    if (__wear_streq(fn, "sama")) {
        return 1;
    }
    if (__wear_streq(fn, "is_quote")) {
        return 1;
    }
    if (__wear_streq(fn, "is_newline")) {
        return 1;
    }
    if (__wear_streq(fn, "is_digit")) {
        return 1;
    }
    if (__wear_streq(fn, "is_letter")) {
        return 1;
    }
    if (__wear_streq(fn, "is_space")) {
        return 1;
    }
    if (__wear_streq(fn, "returns_int")) {
        return 1;
    }
    if (__wear_streq(fn, "returns_string")) {
        return 1;
    }
    if (__wear_streq(fn, "is_string_varname")) {
        return 1;
    }
    return 0;
}
...
int is_string_varname(char* name) {
    if (__wear_streq(name, "pending_concat")) {
        return 0;
    }
    if (__wear_streq(name, "peek_i")) {
        return 0;
    }
    if (__wear_streq(name, "peek_scan")) {
        return 0;
    }
    if (__wear_streq(name, "i")) {
        return 0;
    }
    if (__wear_streq(name, "len")) {
        return 0;
    }
    if (__wear_streq(name, "done")) {
        return 0;
    }
    if (__wear_streq(name, "found_plus")) {
        return 0;
    }
    if (__wear_streq(name, "peek_idx")) {
        return 0;
    }
    if (__wear_streq(name, "func_brace_depth")) {
        return 0;
    }
    if (__wear_streq(name, "read_fn")) {
        return 0;
    }
    if (__wear_streq(name, "read_param")) {
        return 0;
    }
    if (__wear_streq(name, "first_param")) {
        return 0;
    }
    ...
    if (len>=4) {
        ...
        if (__wear_streq(p1, "s")) {
            if (__wear_streq(p2, "t")) {
                if (__wear_streq(p3, "r")) {
                    return 1;
                }
            }
            if (__wear_streq(p2, "o")) {
                return 1;
            }
            if (__wear_streq(p2, "c")) {
                return 1;
            }
        }
        if (__wear_streq(p1, "f")) {
            if (__wear_streq(p2, "i")) {
                return 1;
            }
            if (__wear_streq(p2, "u")) {
                return 1;
            }
        }
        ...
        if (__wear_streq(p1, "p")) {
            ...
            if (__wear_streq(p2, "a")) {
                return 1;
            }
        }
        if (__wear_streq(p1, "g")) {
            if (__wear_streq(p2, "l")) {
                return 1;
            }
            if (__wear_streq(p2, "a")) {
                return 1;
    ...
    if (__wear_streq(name, "c")) {
        return 1;
    }
    if (__wear_streq(name, "q")) {
        return 1;
    }
...
int main(int argc, char* argv[]) {
    ...
    char* source = __wear_read_file("input.wr");
